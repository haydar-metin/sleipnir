...
public class CPOPRuntimeScored extends BaseCPOP {
  public CPOPRuntimeScored(MobileApplication A, MobileCloudInfrastructure I) {
    super(A, I);
  }

  public CPOPRuntimeScored(Tuple2<MobileApplication, MobileCloudInfrastructure> t) {
    super(t);
  }
